...
## Assigned course books (not published with this app)

Maxwell, Christian, the Penguin Atlas, Barrows, Tellegen-Couperus, Blaisdell’s *Greek and Roman Oratory*, and the assigned lives remain on the Student Portal. This app does not reproduce those chapters. After a week ends, a review room may discuss them without substituting for the original.

## Primary extracts (public domain)

- Homer, *Odyssey* (opening; sense of the Laertes scene). Greek text in the public domain.
- *Res Gestae Divi Augusti*.
- Dictatus Papae (Gregory VII’s register), in public-domain English wording.
- Short sense of Atrahasis, the type of Ptahhotep, Virgil *Aeneid* 1.33, Tacitus *Agricola* 30 — cited as rooms, not printed at assigned-PDF length.
...
Downloaded from Wikimedia Commons, 2026-09-06. See `maps/CREDITS.json` for per-file licence (public domain, CC BY-SA 3.0/4.0). CC BY-SA maps must keep the credit line shown under the map in the room. Do not strip attribution when restyling.

| File | Commons title | Licence (as reported) |
|---|---|---|
| whole-past.svg | course schematic | course-made |
| ane.png | Near East 1400 BCE.png | Public domain |
| greece.jpg | Mainland Greece at the time of the Greco-Persian Wars.jpg | Public domain |
| alexander.jpg | Map of the Empire of Alexander the Great (1893).jpg | Public domain |
| italy.jpg | The Growth of Roman Power in Italy.jpg | Public domain |
| roman-med.png | Roman Empire 125.png | CC BY-SA 3.0 |
| late-empire.png | The Roman Empire ca 400 AD.png | Public domain |
| carolingian.png | The Frankish kingdom under Charlemagne… to 900.jpg (Spruner-Menke) | Public domain |
| investiture.jpg | C. 1097 Europe and Mediterranean Lands.jpg | Public domain |
